...
<title>Portage Park Handyman - How Green is Your Handyman?</title>
<!-- #EndEditable --> 
...
<link rel="stylesheet" type="text/css" href="css/how_green.css">
</head>
...
<!-- PUT THE BODY STUFF HERE -->
          <tr><td id="kwerp">
                <h3>How Green is Your Handyman?</h3>
                <br />
                <div class="prehead">
...
<a href="toolsmats.php#wfact">Click here for more information.</a>
                ...
                <div class='greenDiv'>
                    <dt class="greenPrehead">Rebuilding Exchange</dt>
                    <div class="prehead">
                        When I install new items for cosmetic preference, I donate a 
                        functional fixture or faucet to 
                        <a href="http://rebuildingexchange.org" target="_blank">
                            Rebuilding Exchange.
                        </a>
                    </div>
                </div>
                <div class='greenDiv'>
                    <dt class="greenPrehead">No Parts Left Unused</dt>
                    <div class="prehead">
